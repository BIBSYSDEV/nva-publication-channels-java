...
import no.sikt.nva.pubchannels.dataporten.model.FetchTokenResponse;
...
public class DataportenAuthClient implements AuthClient {
    ...
    private FetchTokenResponse fetchToken(HttpRequest request) throws ApiGatewayException {
    ...
    private FetchTokenResponse executeRequest(HttpRequest request)
        ...
        return attempt(() -> dtoObjectMapper.readValue(response.body(), FetchTokenResponse.class)).orElseThrow();
    }
